...
// only data from store 1 is called 
...
and store_pr_id='1' order by store_id ";
...
<tr class="<?php if(isset($classname)) echo $classname;?>">
	...
	<input type="hidden" name="sp" value="<?php echo $row["store_pr_id"] = '2'; ?>" id="sp" readonly></input>
