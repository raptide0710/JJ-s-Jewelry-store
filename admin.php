...
?>
	...
	<p><?php echo $row["fname"]," ", $row["lname"];?>  you will now be able to view differnt reports, delete users and move stock between stores and from the stock warehouse to the stores </p>
